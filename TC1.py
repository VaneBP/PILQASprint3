...
#Escribe el producto "Billetera" en el campo de búsqueda
...
campoBusqueda.send_keys("billetera")
campoBusqueda.send_keys(Keys.ENTER)
time.sleep(5)

#Hace click en el producto "Billetera Paris" 
billeteraParis = driver.find_element(
